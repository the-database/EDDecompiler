...
def initDatFileNameTable(gamePath):
    ...
    with open(rf'{GAME_PATH}\gamedata\data_3rd\scenario\2\map.txt') as f:
        DatFileNameTable['ED6_DT21'] = [line for line in f.read().split('\n') if line]
    with open(rf'{GAME_PATH}\gamedata\data_3rd\chr\npl_pt.txt') as f:
        DatFileNameTable['ED6_DT07'] = [line for line in f.read().split('\n') if line]
    with open(rf'{GAME_PATH}\gamedata\data_3rd\chr\npl2_pt.txt') as f:
        DatFileNameTable['ED6_DT27'] = [line for line in f.read().split('\n') if line]
    with open(rf'{GAME_PATH}\gamedata\data_3rd\chr\apl_pt.txt') as f:
        DatFileNameTable['ED6_DT06'] = [line for line in f.read().split('\n') if line]
    with open(rf'{GAME_PATH}\gamedata\data_3rd\chr\apl2_pt.txt') as f:
        DatFileNameTable['ED6_DT26'] = [line for line in f.read().split('\n') if line]
    with open(rf'{GAME_PATH}\gamedata\data_3rd\chr\mons_pt.txt') as f:
        DatFileNameTable['ED6_DT09'] = [line for line in f.read().split('\n') if line]
    with open(rf'{GAME_PATH}\gamedata\data_3rd\chr\mons2_pt.txt') as f:
        DatFileNameTable['ED6_DT29'] = [line for line in f.read().split('\n') if line]

    # for key in DatFileNameTable:
        # for i in range(len(DatFileNameTable[key])):
            # print(key,i,DatFileNameTable[key][i])
    print('====ok=====')
