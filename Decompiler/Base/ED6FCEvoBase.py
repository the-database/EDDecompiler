...
def initDatFileNameTable(gamePath):
    ...
    # hack for evo
    with open(rf'{GAME_PATH}\scenario\0\map.txt') as f:
        DatFileNameTable['ED6_DT01'] = [line for line in f.read().split('\n') if line]
    ...
    def __init__(self, param):
        ...
        if isinstance(param, int):
            ...
            # print(DatFileNameTable)
                # print(dat, param, hex(param) & 0xFFFF)
                # print(dat, len(DatFileNameTable[dat]), param, param & 0xFFFF)
                self.FileName = '%s/%s' % (dat, DatFileNameTable[dat][param & 0xFFFF])
            except:
                self.FileName = ''
                print('NO!!!', dat, len(DatFileNameTable[dat]), param, param & 0xFFFF)
                # print(DatFileNameTable.keys(), param, param & 0xFFFF, dat)
