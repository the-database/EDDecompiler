...
def scp_call(data):
    ...
    if data.Reason == HANDLER_REASON_DISASM:
        ...
        data.Instruction.OperandFormat = 'CC'
...
def scp_create_setchrname(data):
...
[   inst(ExitThread),
	...
	inst(Call,                      NO_OPERAND,             0,                          scp_call),          # Call(scp index, func index)
	...
	inst(ShowSaveMenu),
	inst(EventBegin,                'B'),
	inst(EventEnd,                  'B'),inst(OP_19,                     'BBW'),
	...
	inst(OP_51),
	inst(OP_52,                     'B'),
	inst(MenuTitle,                  NO_OPERAND,             0,                          scp_menu_title),
	...
	inst(MenuEnd,                   'W'),
	inst(OP_5B,                     'W'),
	inst(SetChrName,                NO_OPERAND,             0,                          scp_create_setchrname),
	inst(OP_5D,                     'W'),
	inst(OP_5E,                     'WLIBBLB'),
	inst(OP_5F,                     'W'),
	inst(OP_60,                     'BW'),
